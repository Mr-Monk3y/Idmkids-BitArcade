...
class InputManager:
    ...
    def obtener_entrada_serial(self, mensaje):
        """Convierte un mensaje recibido por serial en una entrada de jugador."""
        ...
        if entrada_texto not in self.entradas_serial:
            return None

        entrada = self.entradas_serial[entrada_texto]

        return EntradaJugador(jugador, entrada)
